        ...
        <tbody>
          @foreach ($users as $user)
            <tr>
              ...
              <td>
                <img src="{{ $user->profile_picture ? asset('storage/' . $user->profile_picture) : asset('template/img/undraw_profile.svg') }}" class="img-profile rounded-circle" style="width: 50px; height: 50px;">
              </td>
